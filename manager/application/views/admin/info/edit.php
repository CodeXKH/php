	...
	<body>
		...
		<div id="layout_right_content" class="layout_right_content">
			...
			<div class="route_bg">
				...
				<a href="javascript:void(0)">更新采购信息</a>
			</div>
			<!--更新采购信息面包屑结束-->
			...
			<div class="route_con">
				...
				<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="email" class="form-control" id="people" maxlength="20" name="people"  value="<?=$info->people?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="email" class="form-control" id="createTime" maxlength="20" name="createTime"  value="<?=$info->createTime?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="email" class="form-control" id="price" maxlength="20" name="price"  value="<?=$info->price?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" rows="3" placeholder="详情描述" id="detail"  name="detail" ><?=$info->detail?></textarea>
						</div>
					</div>
		...
		<script type="text/javascript">
			...
			function submitdata() {
				...
				$.ajax({
					type: "post",
					url: "<?php echo site_url('admin/info/main/info_update');?>",
					data: {
						"people": people,
						"departId": departId,
					...
					success: function(data) {
						if (data == 1) {
							toastr.success("更新成功");
							location.href="<?php echo base_url().'admin/info/main'?>";
						} else {
							toastr.error("更新失败");
						}
					}
